...
function getTitles() {
    let output = '';
    movies.map(movie => output += `<ul id="movie-${movie.title}"><li><b>${movie.title}</b> <br> 
...
function getGoodMovies() {
    ...
    good.map(movie => goodMovies += `<ul id="movie-${movie.title}"><li><b><b>${movie.title}</b> <br> Rating: ${movie.rating} <br> 
        <button class ="btn btn-poster" onclick="getPosterPic('${movie.title}')">See Poster</button><br></li><br></ul>`)
...
function getAverageMovies() {
    ...
    average.map(movie => aveMovies += `<ul id="movie-${movie.title}"><li><b>${movie.title}</b> <br> Rating: ${movie.rating} <br> 
        <button class ="btn btn-poster" onclick="getPosterPic('${movie.title}')">See Poster</button><br></li><br></ul>`)
...
function getBadMovies() {
    ...
    bad.map(movie => badMovies += `<ul id="movie-${movie.title}"><li><b>${movie.title}</b> <br> Rating: ${movie.rating} <br> 
        <button class ="btn btn-poster" onclick="getPosterPic('${movie.title}')">See Poster</button><br></li><br></ul>`)
